...
describe("Addition", function () {
  it("Should give 5 + 3 = 8", function () {
    ...
    cy.visit("http://127.0.0.1:5500/index.html"); //Set up initial state 
  ...
  it("Should give 25 + 3 = 8", function () {
    cy.visit("http://127.0.0.1:5500/index.html"); // cy.visit("https://josieailsa.github.io/js-calculator-chalenge/")
  ...
  it("Should give 2.5 + 2.5 = 5", function () {
    cy.visit("http://127.0.0.1:5500/index.html"); // cy.visit("https://josieailsa.github.io/js-calculator-chalenge/")
...
describe("Subtraction", function () {
  ...
  it("Should give 10.5 - 1.5 = 9", function () {
    cy.visit("http://127.0.0.1:5500/index.html"); // cy.visit("https://josieailsa.github.io/js-calculator-chalenge/")
...
describe("Mixed sums ", function () {
  it("Should give 2 + 8 - 4 = 6", function () {
    cy.visit("http://127.0.0.1:5500/index.html"); //Set up initial state 
    // cy.visit("https://josieailsa.github.io/js-calculator-chalenge/")
    //query an elemenet 
  ...
  it("Should give 2 * 8 - 4 = 12", function () {
    cy.visit("http://127.0.0.1:5500/index.html"); //Set up initial state 
    // cy.visit("https://josieailsa.github.io/js-calculator-chalenge/")
    //query an elemenet 
  ...
  it("Should give 10 * 4 / 5 = 8", function () {
    cy.visit("http://127.0.0.1:5500/index.html"); //Set up initial state 
    // cy.visit("https://josieailsa.github.io/js-calculator-chalenge/")
    //query an elemenet 
